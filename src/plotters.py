...
def plot_cloud_analysis(cloud_dict, 
                        output_directory, 
...
def plot_demand_profiles(peak_drift_list, 
                         peak_accel_list, 
                         control_nodes, 
                         output_directory,
                         plot_label):
...
def plot_fragility_analysis(cloud_dict, 
                            output_directory, 
...
def plot_ansys_results(cloud_dict,
                       peak_drift_list,
                       peak_accel_list,
                       control_nodes,
                       output_directory,
...
def animate_model_run(control_nodes, acc, dts, nrha_disps, nrha_accels, drift_thresholds, pflag=True):
    """
